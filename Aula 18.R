...
colnames(br) <-  c("PIB","Emprego","C�mbio")   #Renomeia as colunas para PIB, Trabalho e Câmbio
BR <- br[45:62,1:3]
...
h1 = hchart(PIb, name = "PIB", color = "#B71C1C")
  hc_title(h1,text = "Varia��o do PIB do Brasil", margin = 10, style = list(fontSize= "14px")) #Gráfico do PIB

h2 = hchart(Emprego, name = "EMPREGO", color = "black")
  hc_title(h2,text = "Varia��o do Emprego", margin = 10, style = list(fontSize= "14px")) #Gráfico do Emprego

h3 = hchart(Cambio, name = "C�mbio", color = "darkgreen")
  hc_title(h3,text = "Varia��o do C�mbio (R$/U$$)", margin = 10, style = list(fontSize= "14px")) #Gráfico do Câmbio
